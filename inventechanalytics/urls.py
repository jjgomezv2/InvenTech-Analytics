...
urlpatterns = [
    ...
    path('home/', inventechViews.home, name='home'),
    ...
    path('shipmentCreation/<str:product_id>/', shipmentViews.create_shipment, name='shipmentCreation'),
    ...
    path('', accountViews.landing, name='landing')
]
